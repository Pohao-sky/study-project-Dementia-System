...
vegetables: Set[str] = {
    ...
    # 瓜果類
    "茄子", "青花菜", "苦瓜", "胡瓜", "大黃瓜", "小黃瓜", "冬瓜", "絲瓜", "佛手瓜", "瓠瓜", "絲瓜",
    ...
    # 筍類
    "竹筍", "麻竹筍", "綠竹筍", "孟宗竹筍", "桂竹筍", "箭竹筍", "茭白筍","玉米筍",
...
animals: Set[str] = {
    ...
    "豬", "兔子", "兔", "狐狸", "狼", "駱駝", "袋鼠", "熊", "熊貓", "松鼠", "鼴鼠", "天竺鼠", "荷蘭豬","鬥牛",'安哥拉兔',
    "浣熊", "豪豬", "刺蝟", "斑馬", "綿羊", "山羊", "羚羊", "山豬", "土撥鼠", "水牛", "蝙蝠", "白虎",'垂耳兔','侏儒兔',
    ...
    "燕子", "麻雀", "烏鴉", "企鵝", "皇帝企鵝", "國王企鵝", "駝鳥", "雉雞", "野雞", "白鷺鷥","海鷗","白頭翁","渡鴉",
    ...
    # 水生動物
    "魚", "鯨魚", "鯊魚", "章魚", "海豚", "水母", "海馬", "河馬", "海星", "海豹", "海獅", "海龜", "海狗", "魟","魟魚", "垃圾魚", "清道夫",
    "鱷魚", "白鯨" , "藍鯨", "虎鯨", "殺人鯨", "沙丁魚", "比目魚", "鱔魚", "蝦子", "龍蝦", "熱帶魚","大白鯊","格陵蘭鯊","雙髻鯊",
    "螃蟹" , "寄居蟹", "水蛭", "海兔","垂頭鯊","鬼蝠魟"

    # 其他
    "鸚鵡螺", "小熊貓", "蝸牛", "蛞蝓", "食蟻獸", "福壽螺","渦蟲","藤壺"
}
